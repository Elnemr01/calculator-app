    ...
    return (
        <div className='keys'>
            <div className="math-keys">
                ...
                <button key={indx} onClick={()=> handleButton(item)}>{item}</button>
                )}
            </div>
            ...
            <div className="basicKeys">
                ...
                <button key={indx} onClick={()=> handleButton(item)} className={`${item>='0' && item<='9' ? "number" :"NAN"} ${item==="=" && "equal" }`}>{item}</button>
                )}
            </div>
        </div>
    )
